...
IoT-data-simulator can send payload to the following *target systems* (with available security types in parentheses):
 ...
 - Kafka (certificates, DSH certificates)
...
A: In our company we used IoT data simulator tool for working with Thingsboard, AWS, Predix and DSH platforms. But it doesn't mean that it cannot be used with others.
